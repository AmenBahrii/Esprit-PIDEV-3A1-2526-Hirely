...
"""
FILE ROLE: Local FastAPI AI scoring service used by the Hirely forum moderation engine.
FILE: hirely/ai_service/app.py
"""
...
- Integration role: called by the Symfony forum Python AI client in the moderation flow.
"""
